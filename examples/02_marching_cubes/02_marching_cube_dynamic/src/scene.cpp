...
void scene_structure::display_info()
{
	...
	std::cout << "\nSCENE INFO:" << std::endl;
	std::cout << "-----------------------------------------------" << std::endl;
	std::cout << "This scene demonstrates a dynamic implicit surface generated interactively using the marching cube algorithm with a user-controlled field function." << std::endl;
	std::cout << "-----------------------------------------------\n" << std::endl;
}
