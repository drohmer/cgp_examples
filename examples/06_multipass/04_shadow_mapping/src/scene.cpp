...
void scene_structure::display_info()
{
	...
	std::cout << "\nSCENE INFO:" << std::endl;
	std::cout << "-----------------------------------------------" << std::endl;
	std::cout << "This scene demonstrates shadow mapping: a depth map is rendered from the light viewpoint in a first pass and used to shade the scene in the second pass." << std::endl;
	std::cout << "-----------------------------------------------\n" << std::endl;
}
