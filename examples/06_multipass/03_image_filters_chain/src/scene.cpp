...
void scene_structure::display_info()
{
	...
	std::cout << "\nSCENE INFO:" << std::endl;
	std::cout << "-----------------------------------------------" << std::endl;
	std::cout << "This scene demonstrates chaining multiple rendering passes: a convolution filter followed by a thickening filter applied sequentially." << std::endl;
	std::cout << "-----------------------------------------------\n" << std::endl;
}
