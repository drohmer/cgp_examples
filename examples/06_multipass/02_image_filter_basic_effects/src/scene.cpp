...
void scene_structure::display_info()
{
	...
	std::cout << "\nSCENE INFO:" << std::endl;
	std::cout << "-----------------------------------------------" << std::endl;
	std::cout << "This scene demonstrates a collection of image filter effects (contours, convolution, color grading, deformation) selectable at runtime via the GUI." << std::endl;
	std::cout << "-----------------------------------------------\n" << std::endl;
}
