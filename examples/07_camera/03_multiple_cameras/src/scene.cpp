...
void scene_structure::display_info()
{
	...
	std::cout << "\nSCENE INFO:" << std::endl;
	std::cout << "-----------------------------------------------" << std::endl;
	std::cout << "This scene demonstrates the use of two independent cameras: the same cube is drawn twice from different viewpoints by swapping the camera view matrix." << std::endl;
	std::cout << "-----------------------------------------------\n" << std::endl;
}
